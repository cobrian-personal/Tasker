...
def showTasks(taskList):
    ...
    t = taskListtemp[taskListtemp.Complete == False].filter(items=["Task Name", "Due Date", "Label", "Notes"])
    print(colored(t,"cyan"))
    print()
    t1 = taskListtemp[taskListtemp.Complete == True].filter(items=["Task Name", "Due Date", "Label", "Notes"])
